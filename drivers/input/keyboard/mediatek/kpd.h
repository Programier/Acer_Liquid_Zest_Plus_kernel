...
struct slide_dev
{
       ...
       struct pinctrl_state *slide_eint_default;
       struct pinctrl_state *slide_eint_pullup;
       struct pinctrl_state *slide_eint_pulldown;
       struct device_node       *slide_of_node;
       unsigned int slide_irq;
       unsigned int irq_flag;
};
extern struct input_dev *kpd_input_dev;
extern struct slide_dev g_slide_dev;
