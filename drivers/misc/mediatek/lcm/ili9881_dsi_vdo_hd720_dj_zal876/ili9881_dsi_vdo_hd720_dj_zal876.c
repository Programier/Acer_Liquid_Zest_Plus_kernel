...
//    params->dbi.te_edge_polarity		= LCM_POLARITY_RISING;
	 ...
	 params->dsi.horizontal_backporch				 = 8;//70;50
	 params->dsi.horizontal_frontporch				 = 90;//80;60
	 params->dsi.horizontal_blanking_pixel			 = 60;//100;80
	 params->dsi.horizontal_active_pixel			 = FRAME_WIDTH;
	 
	 // Bit rate calculation
	   //params->dsi.LPX=8; 
	#ifdef CONFIG_HQ_PROTECT_LAVA
	params->dsi.PLL_CLOCK=200;
	#else
#ifdef CONFIG_HQ_ZAL876MMX
...
LCM_DRIVER ili9881_dsi_vdo_hd720_dj_zal876_lcm_drv = 
{
	.name			= "ili9881_dsi_vdo_hd720_dj_zal876",
