...
if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX219_MIPI_RAW_QTW_ZAW875, currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX219_MIPI_RAW_OFG_ZAW875, currSensorName))))
			{
      ...
      {
            //First Power Pin low and Reset Pin Low
             printk("junpiao:[PowerON]ov5670_qh, pinSetIdx = %d\n", pinSetIdx);
