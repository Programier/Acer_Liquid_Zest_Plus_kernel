...
#include "../../power/mt6735/bq25890.h"
...
void mt_usb_set_vbus(struct musb *musb, int is_on)
{
	...
	{
		int ret = 0;
		ret = gpio_direction_output(HQ_CHARGER_LED_GPIO, 0);
     	__gpio_set_value(HQ_CHARGER_LED_GPIO, 0);	
    	printk("[@@mingxing] led_gpio ret = %d\n", ret);
	...
	#elif defined(CONFIG_MTK_BQ25890_SUPPORT)
		bq25890_otg_en(1);
	#else
		#ifdef CONFIG_OF
		#if defined(CONFIG_MTK_LEGACY)
