...
//+fanmingxing flashlight2015/11
#ifdef CONFIG_OF
static const struct of_device_id Kd_flashlight_of_ids[] = {
	{.compatible = "mediatek,Kd_flashlight",},
	{}
};
#endif
//-sfanmingxing flashlight2015/11
...
static struct platform_driver flashlight_platform_driver = {
	...
	.driver = {
		   ...
		   .owner = THIS_MODULE,
    #ifdef CONFIG_OF
		   .of_match_table = Kd_flashlight_of_ids,//+fanmingxing flashlight2015/11
    #endif
		   },
};
